# Capability: Awakening Combined Display

## Purpose
Handles the display of combined (personal + class) base stats and growth rates for Awakening units across all stat display components.
