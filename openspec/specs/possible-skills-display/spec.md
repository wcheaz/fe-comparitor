# Capability: possible-skills-display

## Purpose

Displays all skills a unit could potentially learn by reclassing, including skills from promoted classes of those reclass options. Provides class-name annotations and tier/level-based color coding for visual differentiation.
