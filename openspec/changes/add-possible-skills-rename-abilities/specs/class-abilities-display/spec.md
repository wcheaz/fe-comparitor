...
> **Important game context**: FE6 and FE7 do **not** have a formal "skills" system — skills in these games are flat stat bonuses or innate movement/utility traits. FE8 introduces a proper skills system where specific classes gain activation-based skills (Great Shield, Pierce, Silencer, Slayer, Sure Strike). All are stored uniformly as strings in `classSkills`.
>
...
- **WHEN** a class has no special innate skills (e.g., Cavalier, Mage)
