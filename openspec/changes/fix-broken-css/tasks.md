...
- [ ] 2.1 Refactor `app/comparator/page.tsx`'s layout container (`<div className="grid grid-cols-1 lg:grid-cols-4 gap-6">`) and main content area to handle the new horizontal layout.
